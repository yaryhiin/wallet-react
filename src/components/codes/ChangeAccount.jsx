...
const ChangeAccount = ({ accounts, changeAccount, deleteAccount }) => {
  ...
  const title = t("modal.account.title");
  const text = `${t("modal.account.part1")} ${account.balance} ${account.currency} ${t("modal.account.part2")}`;
  ...
  return (
    <div className={styles.formContainer}>
      <h1 className={styles.heading}>{t("account.changeAcc")}</h1>
